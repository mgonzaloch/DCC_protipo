    ...
    public class Info extends Fragment {
        ...
        private String tiproducto = "otros";

        private DatabaseReference otrosref,productossref;
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            otrosref = FirebaseDatabase.getInstance().getReference().child("productos_otros");
        ...
        public void onStart()
        {
            ...
            FirebaseRecyclerOptions options =
                    new FirebaseRecyclerOptions.Builder<modelp>()
                            .setQuery(otrosref,modelp.class)
                            .build();

            FirebaseRecyclerAdapter<modelp,productosViewHolder> adapter
                    =new FirebaseRecyclerAdapter<modelp, productosViewHolder>(options)

            {
                @Override
                protected void onBindViewHolder(@NonNull final productosViewHolder productosViewHolder, int position, @NonNull modelp modelp)
                {
