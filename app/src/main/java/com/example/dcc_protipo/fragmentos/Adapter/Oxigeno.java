     ...
     */
    public class Oxigeno extends Fragment {

        private RecyclerView lista;

        private DatabaseReference Oxigenoref, productossref;
        private String tiproducto = "oxigeno";
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View view = inflater.inflate(R.layout.fragment_oxigeno, container, false);

            lista = view.findViewById(R.id.RecyclerInfo);
            lista.setLayoutManager(new LinearLayoutManager(getContext()));

            Oxigenoref = FirebaseDatabase.getInstance().getReference().child("productos_oxigeno");
        ...
        public void onStart()
        {
            ...
            FirebaseRecyclerOptions options =
                    new FirebaseRecyclerOptions.Builder<modelp>()
                            .setQuery(Oxigenoref,modelp.class)
                            .build();
        ...
        private static class productosViewHolder extends RecyclerView.ViewHolder
        {
